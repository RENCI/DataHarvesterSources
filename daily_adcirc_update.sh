...
if [ "$hour" -eq "00" ] || [ "$hour" -eq "06" ] || [ "$hour" -eq "12" ] || [ "$hour" -eq "18" ]
    then
        ...
        python fetch_adcirc_data.py --url "http://tds.renci.org:8080/thredds/dodsC/$year/nam/$urltime/hsofs/hatteras.renci.org/hsofs-nam-bob-2021/nowcast/fort.61.nc" --data_source 'ASGS'
